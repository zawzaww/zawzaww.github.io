...
# Make Fixes
Linux kernel main source tree ကို [https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git](https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git) ကနေ တဆင့် source code ကို ရယူနိုင်ပါတယ်။ ဘာတွေ Fix လုပ်မလဲဆိုရင် Linux kernel development ကို အတိုင်းတာတခုထိ လေ့လာထားမှသာ ပိုပြီးသိလာပါလိမ့်မယ်။ အခုမှ စလုပ်မယ့်သူတွေကိုတော့ ဘယ်အပိုင်းတွေကို Fix ပြီး Contribute လုပ်မလဲဆိုတာတော့ ပြောရခက်ပါတယ်။ တခြား Software project တွေလိုမျိုး လုပ်နေရင်းနဲ့ သိလာတာမျိုးပါပဲ။ Kernel Hacking ပိုင်း စိတ်၀င်စားရင်တော့ [Linux Kernel Newbies](https://kernelnewbies.org/KernelHacking) မှာ လေ့လာနိုင်ပါတယ်။ ကိုယ်ရဲ့ စိတ်၀င်စားမှုပေါ်မှာ မူတည်ပါတယ်။

ပထမ အစပိုင်းမှာ Linux kernel တခုလုံးရဲ့ Subsystem အကုန်လုံးကို လိုက်လုပ်စရာ မလိုပါဘူး။ ဥပမာ - ကိုယ်က File Systems `/linux/fs` ကို စိတ်၀င်စားတာလား ဒါမှမဟုတ် Kernel Device Drivers/Modules `/linux/drivers` တွေ ရေးချင်တာလား ဒါမှမဟုတ် Networking subsystem (e.g: Network core, bridge, wireless and etc..) `/linux/net` ကို လုပ်ချင်တာလား သို့မဟုတ် Security ပိုင်း အားသာတယ်ဆိုရင် Kernel Security (e.g SELinux, Kernel lockdown and etc..) `/linux/security` ပိုင်း စသဖြင့် Kernel Subsystems တွေက အများကြီး ရှိနေပါတယ်။ တခုခုကို အစပိုင်း Specialize လုပ်ပြီး လေ့လာသင့်ပါတယ်။ တခြား Kernel Subsystem နဲ့စာရင် တကယ့် Embedded Linux World မှာ Embedded Hardware Devices အတွက် Kernel Device Drivers/Modules တွေ ရေးတာက ပိုပြီး Popular ဖြစ်ပြီး လေ့လာလိုက်စားသူ များပါတယ်။ ကျွန်တော့်အနေနဲ့လည်း တခြား Kernel Subsystems တွေကို အများကြီး မလုပ်ဖူးသေးပါဘူး။ Kernel Device Drivers အပိုင်းမှာပဲ Specialize လုပ်ပြီး အဓိကထားပြီး လေ့လာနေတဲ့သူတယောက် ဖြစ်ပါတယ်။
...
<p align="center"><img src="https://mhatsu.to/content/images/2020/06/linux-device-drivers-book.jpg"></img></p>
