...
### Understanding application's concepts
...
```sh
helm template <chart_name> <dir_name> --values <values_file_path>
```
...
This is automatically generated by Helm based on you wrote Helm templates and values.
